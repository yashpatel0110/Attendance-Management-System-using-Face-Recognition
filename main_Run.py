    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/Dell/Downloads/ATTENDANCE MANAGEMENT SYSTEM/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:\Users\Dell\Downloads\ATTENDANCE MANAGEMENT SYSTEM\Attendance\Manually Attendance-------Check atttendance-------"')
    ...
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'C:/Users/Dell/Downloads/ATTENDANCE MANAGEMENT SYSTEM/Attendance/Manually Attendance' + fileName
    ...
    def log_in():
        ...
        if username == 'pragya':
            if password == 'pragya123':
                ...
                cs = 'C:/Users/Dell/Downloads/ATTENDANCE MANAGEMENT SYSTEM/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
